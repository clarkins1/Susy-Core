...
public class SusyMetaEntities {
    ...
    public static void init() {
        EntityRegistry.registerModEntity(new ResourceLocation(SuSyValues.MODID, "drop_pod"), EntityDropPod.class, "Drop Pod", 1, Supersymmetry.instance, 64, 3, true);
        EntityRegistry.registerModEntity(new ResourceLocation(SuSyValues.MODID, "drone"), EntityDrone.class, "Drone", 2, Supersymmetry.instance, 64, 3, true);
    }
